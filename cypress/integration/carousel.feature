Feature: Carousel
    @carousel
        Scenario: Successful change current image on carousel with right arrow button
            Given I navigate to the home page
            When I click the right arrow button
            Then I should see that the current image on the carousel changes

    @carousel
        Scenario: Successful change current image on carousel with left arrow button
            Given I navigate to the home page
            When I click the left arrow button
            Then I should see that the current image on the carousel changes
    
    @carousel
        Scenario: Successful change current image on carousel with carousel first indicator
            Given I navigate to the home page
    ...
    @carousel
        Scenario: Successful change current image on carousel with carousel second indicator
            Given I navigate to the home page
    ...
    @carousel
        Scenario: Successful change current image on carousel with carousel third indicator
            Given I navigate to the home page
